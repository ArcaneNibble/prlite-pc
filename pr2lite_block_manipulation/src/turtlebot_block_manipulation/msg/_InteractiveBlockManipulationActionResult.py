...
class InteractiveBlockManipulationActionResult(roslib.message.Message):
  ...
  _type = "turtlebot_block_manipulation/InteractiveBlockManipulationActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','turtlebot_block_manipulation/InteractiveBlockManipulationResult']
