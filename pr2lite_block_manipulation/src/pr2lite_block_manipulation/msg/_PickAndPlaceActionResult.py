...
class PickAndPlaceActionResult(roslib.message.Message):
  ...
  _type = "pr2lite_block_manipulation/PickAndPlaceActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2lite_block_manipulation/PickAndPlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pr2lite_block_manipulation.msg.PickAndPlaceResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr2lite_block_manipulation.msg.PickAndPlaceResult()
