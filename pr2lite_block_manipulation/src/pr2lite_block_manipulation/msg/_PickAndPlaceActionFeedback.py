...
class PickAndPlaceActionFeedback(roslib.message.Message):
  ...
  _type = "pr2lite_block_manipulation/PickAndPlaceActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','pr2lite_block_manipulation/PickAndPlaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pr2lite_block_manipulation.msg.PickAndPlaceFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr2lite_block_manipulation.msg.PickAndPlaceFeedback()
