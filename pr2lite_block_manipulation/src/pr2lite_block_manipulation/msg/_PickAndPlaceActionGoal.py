...
class PickAndPlaceActionGoal(roslib.message.Message):
  ...
  _type = "pr2lite_block_manipulation/PickAndPlaceActionGoal"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalID','pr2lite_block_manipulation/PickAndPlaceGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = pr2lite_block_manipulation.msg.PickAndPlaceGoal()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = pr2lite_block_manipulation.msg.PickAndPlaceGoal()
