...
#msg.name = [r_gripper_l_finger_joint, r_gripper_l_finger_tip_joint, r_gripper_motor_screw_joint, r_gripper_r_finger_joint, r_gripper_r_finger_tip_joint, r_gripper_joint, bl_wheel_joint, br_wheel_joint, fl_wheel_joint, fr_wheel_joint]

#msg.name = [ "world_joint/x", "world_joint/y", "world_joint/theta", "r_gripper_l_finger_joint", "r_gripper_l_finger_tip_joint", "r_gripper_motor_screw_joint", "r_gripper_r_finger_joint", "r_gripper_r_finger_tip_joint", "r_gripper_joint", "bl_wheel_joint", "br_wheel_joint", "fl_wheel_joint", "fr_wheel_joint"]
msg.name = [ "r_gripper_l_finger_joint", "r_gripper_l_finger_tip_joint", "r_gripper_motor_screw_joint", "r_gripper_r_finger_joint", "r_gripper_r_finger_tip_joint", "r_gripper_joint", "bl_wheel_joint", "br_wheel_joint", "fl_wheel_joint", "fr_wheel_joint"]
