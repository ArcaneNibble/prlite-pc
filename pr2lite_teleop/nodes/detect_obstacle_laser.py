...
import roslib; roslib.load_manifest('pr2lite_teleop')
import rospy
...
class DetectObstacleLaser():
    def __init__(self):
        ...
        self.obstacle_pub = rospy.Publisher("base_laser_obstacle", Bool)
    ...
    def process_scan(self, msg):
        ...
        for i in range(start_index, stop_index):
            ...
            if not isnan(distance) and distance < self.safe_distance and distance > msg.range_min and distance < msg.range_max:
