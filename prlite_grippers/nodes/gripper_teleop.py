...
#       self.move_left_right = 3  # right Joy: 1 = right -1 = left 
        ...
        # ROS dynamixel controllor doc: http://www.ros.org/wiki/dynamixel_controllers
        # dynamixel ax12 doc: http://support.robotis.com/en/product/dynamixel/ax_series/dxl_ax_actuator.htm#Actuator_Address_22
        self.torque = 500
