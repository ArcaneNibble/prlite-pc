...
class JointStatePublisher():
    def __init__(self):
        ...
        self.joints.append('elbow_pan_controllerL')
        self.joints.append('elbow_tilt_controllerL')
        self.joints.append('wrist_rotate_controllerL')
        self.joints.append('wrist_tilt_controllerL')

        self.joints.append('elbow_pan_controllerR')
        self.joints.append('elbow_tilt_controllerR')
        self.joints.append('wrist_rotate_controllerR')
        self.joints.append('wrist_tilt_controllerR')

        self.joints.append('kinect_tilt_controller')
        self.joints.append('kinect_pan_controller')
        self.joints.append('laser_tilt_controller')

        self.joints.append('finger_right_controllerL')
        self.joints.append('finger_right_controllerR')
        self.joints.append('finger_left_controllerL')
        self.joints.append('finger_left_controllerR')

        self.joints.append('shoulder_tilt_controllerL')
        self.joints.append('shoulder_tilt_controllerR')
        self.joints.append('shoulder_pan_controllerL')
        self.joints.append('shoulder_pan_controllerR')
