/*  pi_rosbridge.js - Version 1.0 2012-09-22
...
*/
    ...
    connection.callService('/rosbridge/get_param', '["pr2lite_rosbridge"]', function(resp) {
	for (param in resp) {
