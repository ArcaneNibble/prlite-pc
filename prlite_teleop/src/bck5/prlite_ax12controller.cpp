...
void prlite_ax12commander::init()
{
   ...
   for (i = 0; i < prlite_ax12commander::numjoints; i ++) {
    ...
    }
    {
      ...
      prlite_ax12joint[lfinger].tuck =  0.1;
      prlite_ax12joint[rfinger].tuck =  0.1;
      ...
      prlite_ax12joint[lfingerR].tuck =  0.1;
      prlite_ax12joint[rfingerR].tuck =  0.1;
      ...
      prlite_ax12joint[lfinger].kinect_callobrate =  .1;
      prlite_ax12joint[rfinger].kinect_callobrate =  .1;
      ...
      prlite_ax12joint[lfingerR].kinect_callobrate =  .1;
      prlite_ax12joint[rfingerR].kinect_callobrate =  .1;
...
void prlite_ax12commander::set_desired_pos(int joint, double desired_pos)
{
  ...
  if (joint != lfingerR && joint != rfingerR)  // bad motors
