...
void prlite_ax12commander::init()
{
   ...
   for (i = 0; i < prlite_ax12commander::numjoints; i ++) {
      ...
      if (i == prlite_ax12commander::shoulderpanR
        ...
        prlite_ax12joint[i].minpos = -1;
        prlite_ax12joint[i].maxpos =  1;
      }
      ...
      prlite_ax12joint[i].tuck =  1;
      prlite_ax12joint[i].untuck =  0;
       ...
       double l_x_vel, double l_y_vel, double l_z_vel)
{
   ...
   JointCommand( prlite_ax12commander::elbowtilt, r_z_vel);
}
